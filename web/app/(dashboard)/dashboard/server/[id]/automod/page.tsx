    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        <div className="flex items-center gap-2 md:gap-3 mb-2">
          <FontAwesomeIcon icon={faShield} className="h-5 w-5 md:h-6 md:w-6 text-blue-400" />
          <h1 className="text-lg md:text-2xl font-bold text-white">Auto Moderation</h1>
        </div>
